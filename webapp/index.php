		...
		<!-- 시작 메뉴 화면 -->
		 <main data-role="page" id="page0">
			<header data-role="header" data-position="fixed" data-theme="b">
				<h1>영화 정보 관리</h1>
				<a href="#page0" data-icon="home" data-iconpos="notext" class="ui-brn-right-">영화목록 (home)</a>
			</header>

			<article data-role="content">
				<img style="margin: 20px auto; display: black;" src="img/cinema.jpg" />
				<ul data-role="listview" data-inset="true">
					<li><a href="./insert.php">영화 정보 추가 </a></li>
					<li><a href="./updata_select.php">영화 정보 수정</a></li>
					<li><a href="./delete_select.php">영회 정보 삭제 </a></li>
